    ...
    public class RepositorioPaciente : IRepositorioPaciente
    {
        ...
        public void IngresarPaciente(Paciente paciente)
        {
            Modelo.Paciente pacienteIngresar = new Modelo.Paciente()
            {
                ...
                IdTipoIdentificacion = paciente.TipoIdentificacion.Id,
        ...
        public void ActualizarPaciente(Paciente paciente)
        {
            ...
            pacienteActual.IdTipoIdentificacion = paciente.TipoIdentificacion.Id;
            ...
            pacienteActual.IdRegimen = paciente.Regimen.Id;
        ...
        public Paciente ObtenerPaciente(string numeroDocumento)
        {
            ...
            if (pacienteActual != null)
                return new Entidades.Paciente()
                {
                    ...
                    TipoIdentificacion = new TipoIdentificacion() { Id = pacienteActual.TipoIdentificacion.Id },
